# Process Limitless Lifelog Weekly
...
This workflow processes weekly lifelog data, generates a summary using OpenAI, and sends it via Telegram.

**Tags**: backup, lifelog, weekly-summary  
**Complexity**: medium  
...
1. **Supabase** (n8n-nodes-base.supabase)
2. **Set Start and End Date** (n8n-nodes-base.set)
3. **OpenAI** (@n8n/n8n-nodes-langchain.open Ai)
4. **Code** (n8n-nodes-base.code)
5. **Insert Weekly Summary** (n8n-nodes-base.supabase)
...
**Nodes**: n8n-nodes-base.scheduleTrigger, n8n-nodes-base.supabase, n8n-nodes-base.set, @n8n/n8n-nodes-langchain.openAi, n8n-nodes-base.code, n8n-nodes-base.telegram
...
**Primary Goal**: This workflow processes weekly lifelog data, generates a summary using OpenAI, and sends it via Telegram.
