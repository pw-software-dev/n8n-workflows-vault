...
This workflow processes tasks by executing a series of actions including enhancing tasks, creating embeddings, and updating Notion database pages.
...
2. **RPC Ingest Task** (n8n-nodes-base.http Request)
3. **Is Success?** (n8n-nodes-base.if)
4. **Is New Item?** (n8n-nodes-base.if)
5. **Enhance Task** (@n8n/n8n-nodes-langchain.agent)
6. **4.1-mini** (@n8n/n8n-nodes-langchain.lm Chat Open Ai)
7. **Fetch Enhance Task Prompt** (n8n-nodes-base.execute Workflow)
8. **Format Markdown to Notion Blocks** (n8n-nodes-base.code)
9. **Create Database Page** (n8n-nodes-base.http Request)
10. **Update a row** (n8n-nodes-base.supabase)
11. **Get a database page** (n8n-nodes-base.notion)
12. **Get Original Task** (n8n-nodes-base.supabase)
13. **Has Notion Page ID?** (n8n-nodes-base.if)
14. **Create Comment** (n8n-nodes-base.http Request)
15. **End Workflow** (n8n-nodes-base.no Op)
16. **Set Properties** (n8n-nodes-base.code)
17. **Create Embeddings** (n8n-nodes-base.http Request)
...
**Credentials**: supabaseApi, openAiApi, notionApi
**Nodes**: n8n-nodes-base.set, n8n-nodes-base.executeWorkflowTrigger, n8n-nodes-base.httpRequest, n8n-nodes-base.if, @n8n/n8n-nodes-langchain.agent, @n8n/n8n-nodes-langchain.lmChatOpenAi, n8n-nodes-base.executeWorkflow, n8n-nodes-base.code, n8n-nodes-base.supabase, n8n-nodes-base.notion, n8n-nodes-base.noOp
...
**Primary Goal**: This workflow processes tasks by executing a series of actions including enhancing tasks, creating embeddings, and updating Notion database pages.
