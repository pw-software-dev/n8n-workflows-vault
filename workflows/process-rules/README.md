...
This workflow processes spoken word transcripts to extract and categorize explicit rules using AI and stores them in a database.

**Tags**: ai, rules, transcription, database  
**Complexity**: medium  
...
2. **OpenAI Chat Model** (@n8n/n8n-nodes-langchain.lm Chat Open Ai)
3. **Structured Output Parser** (@n8n/n8n-nodes-langchain.output Parser Structured)
4. **Split Out** (n8n-nodes-base.split Out)
5. **Create Embeddings** (n8n-nodes-base.http Request)
6. **No Operation, do nothing** (n8n-nodes-base.no Op)
7. **If Match Exists** (n8n-nodes-base.if)
8. **Merge1** (n8n-nodes-base.merge)
9. **Set Item Id** (n8n-nodes-base.set)
10. **Create Row** (n8n-nodes-base.supabase)
11. **Add Page in Database** (n8n-nodes-base.notion)
12. **Update Row with Page Id** (n8n-nodes-base.supabase)
13. **If Rules Not Empty** (n8n-nodes-base.if)
14. **RPC Match Rules** (n8n-nodes-base.http Request)
15. **No Operation, do nothing1** (n8n-nodes-base.no Op)
16. **Add Toggle List** (n8n-nodes-base.http Request)
...
**Credentials**: OpenAi account, Supabase account, Notion account
**Nodes**: n8n-nodes-base.executeWorkflowTrigger, @n8n/n8n-nodes-langchain.agent, @n8n/n8n-nodes-langchain.lmChatOpenAi, @n8n/n8n-nodes-langchain.outputParserStructured, n8n-nodes-base.splitOut, n8n-nodes-base.httpRequest, n8n-nodes-base.noOp, n8n-nodes-base.if, n8n-nodes-base.merge, n8n-nodes-base.set, n8n-nodes-base.supabase, n8n-nodes-base.notion
...
**Primary Goal**: This workflow processes spoken word transcripts to extract and categorize explicit rules using AI and stores them in a database.
