...
This workflow creates a daily backup pull request from a branch to the main branch in a GitHub repository.

**Tags**: backup, github, automation  
**Complexity**: medium  
...
1. **Set Parameters** (n8n-nodes-base.set)
2. **Create Daily Backup PR** (n8n-nodes-base.http Request)
...
**Nodes**: n8n-nodes-base.scheduleTrigger, n8n-nodes-base.set, n8n-nodes-base.httpRequest
...
**Primary Goal**: This workflow creates a daily backup pull request from a branch to the main branch in a GitHub repository.
