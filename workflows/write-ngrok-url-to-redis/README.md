...
This workflow captures an ngrok URL via a webhook and stores it in a Redis database.

**Tags**: webhook, redis, ngrok  
**Complexity**: medium  
...
2. **Set Raspberry PI ngrok URL** (n8n-nodes-base.redis)
...
**Credentials**: Global Header Auth, Redis account
**Nodes**: n8n-nodes-base.webhook, n8n-nodes-base.redis
...
**Primary Goal**: This workflow captures an ngrok URL via a webhook and stores it in a Redis database.
