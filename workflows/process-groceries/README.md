...
This workflow processes a shopping list by adding items to a Notion database and handling empty lists.
...
1. **Add Item to Groceries** (n8n-nodes-base.notion)
2. **Split Out** (n8n-nodes-base.split Out)
3. **Response** (n8n-nodes-base.code)
4. **Edit Fields** (n8n-nodes-base.set)
5. **End Workflow** (n8n-nodes-base.no Op)
6. **Is List Empty?** (n8n-nodes-base.if)
...
**Nodes**: n8n-nodes-base.executeWorkflowTrigger, n8n-nodes-base.notion, n8n-nodes-base.splitOut, n8n-nodes-base.code, n8n-nodes-base.set, n8n-nodes-base.noOp, n8n-nodes-base.if
...
**Primary Goal**: This workflow processes a shopping list by adding items to a Notion database and handling empty lists.
