...
This workflow marks a task as completed by updating a Notion database and managing task counts in Redis.
...
- **Trigger Type**: **n8n-nodes-base.manual Trigger**
...
2. **Get Num Tasks Done** (n8n-nodes-base.redis)
3. **Set Num Tasks Done** (n8n-nodes-base.redis)
4. **Set Input** (n8n-nodes-base.set)
5. **Reset Num Tasks Done** (n8n-nodes-base.redis)
6. **Calc New Num Tasks Done** (n8n-nodes-base.code)
7. **Set Task Done** (n8n-nodes-base.notion)
8. **Respond to Webhook** (n8n-nodes-base.respond To Webhook)
...
**Credentials**: Redis account, Notion account
**Nodes**: n8n-nodes-base.webhook, n8n-nodes-base.redis, n8n-nodes-base.set, n8n-nodes-base.manualTrigger, n8n-nodes-base.code, n8n-nodes-base.notion, n8n-nodes-base.respondToWebhook
...
**Primary Goal**: This workflow marks a task as completed by updating a Notion database and managing task counts in Redis.
