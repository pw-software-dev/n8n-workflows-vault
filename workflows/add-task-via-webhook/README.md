...
This workflow adds a task via a webhook, validates the input, creates embeddings, processes the task, and responds with success or failure.

**Tags**: webhook, task, validation, api  
**Complexity**: medium  
...
2. **Validate Body** (n8n-nodes-base.if)
3. **Create Embeddings** (n8n-nodes-base.http Request)
4. **Process Task** (n8n-nodes-base.execute Workflow)
5. **Respond Success** (n8n-nodes-base.respond To Webhook)
6. **Respond Failure** (n8n-nodes-base.respond To Webhook)
...
**Credentials**: Header Auth, OpenAi account
**Nodes**: n8n-nodes-base.webhook, n8n-nodes-base.if, n8n-nodes-base.httpRequest, n8n-nodes-base.executeWorkflow, n8n-nodes-base.respondToWebhook
...
**Primary Goal**: This workflow adds a task via a webhook, validates the input, creates embeddings, processes the task, and responds with success or failure.
