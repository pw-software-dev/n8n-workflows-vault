# Fetch Lifelogs Every 10 Minutes
...
This workflow fetches lifelogs from an API every 10 minutes, processes them, and updates the last fetched timestamp.
...
1. **HTTP Request** (n8n-nodes-base.http Request)
2. **Get Las Item Fetched Timestamp** (n8n-nodes-base.redis)
3. **Redis** (n8n-nodes-base.redis)
4. **Filter** (n8n-nodes-base.filter)
5. **Process Items** (n8n-nodes-base.execute Workflow)
6. **Telegram** (n8n-nodes-base.telegram)
7. **Calculate Last Item Fetched Timtestamp** (n8n-nodes-base.code)
8. **No Operation, do nothing** (n8n-nodes-base.no Op)
9. **Split Out** (n8n-nodes-base.split Out)
...
**Credentials**: Redis account, Telegram account
**Nodes**: n8n-nodes-base.httpRequest, n8n-nodes-base.scheduleTrigger, n8n-nodes-base.redis, n8n-nodes-base.filter, n8n-nodes-base.executeWorkflow, n8n-nodes-base.telegram, n8n-nodes-base.code, n8n-nodes-base.noOp, n8n-nodes-base.splitOut
...
**Primary Goal**: This workflow fetches lifelogs from an API every 10 minutes, processes them, and updates the last fetched timestamp.
