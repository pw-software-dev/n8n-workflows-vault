...
Automated bidirectional synchronization between external CRM system and internal database with data transformation and error handling

**Tags**: crm, sync, integration, database, automation, scheduled  
**Complexity**: high  
**Estimated Runtime**: 2-5 minutes  
**Compatible n8n Version**: 1.47.0
...
1. **Fetch CRM Contacts** (n8n-nodes-base.http Request)
2. **Transform Data** (n8n-nodes-base.code)
3. **Sync to Internal System** (n8n-nodes-base.http Request)
4. **Success Notification** (n8n-nodes-base.slack)
5. **Error Notification** (n8n-nodes-base.slack)
...
**Credentials**: httpHeaderAuth, httpBasicAuth, slackApi
**Nodes**: Schedule Trigger, HTTP Request, Code, Slack
**Environment Variables**: CRM_API_BASE_URL, INTERNAL_API_BASE_URL
...
#### Prerequisites
1. n8n version 1.47.0 or higher
...
### Intent
**Primary Goal**: Automated bidirectional synchronization between external CRM system and internal database with data transformation and error handling
...
*This documentation was generated from workflow metadata. Last updated: 2024-08-25*